...
class DQNAgent(nn.Module):
    ...
    def get_action(self, observation: np.ndarray, epsilon: float = 0.02) -> int:
        ...
        action = torch.argmax(qa_values, dim=1) if np.random.rand() > epsilon else torch.randint(self.num_actions, (1,))
    ...
    def update_critic(
        ...
        with torch.no_grad():
            ...
            next_q_values = next_qa_values.gather(1, next_action.unsqueeze(1)).squeeze(1) # (batch_size,)
